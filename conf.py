...
BLOG_AUTHOR = "The Notebuying Cat"  # (translatable)
BLOG_TITLE = "The Notebuying Cat"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.thenotebuyingcat.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.thenotebuyingcat.com/"
BLOG_EMAIL = "thenotebuyingcat@gmail.com"
BLOG_DESCRIPTION = "We buy mortgages in cash"  # (translatable)
